...
- **The "Ready to record calls" notification can be hidden.** *Settings ▸ General ▸ Visual settings ▸
  Status notification* opens Android's own switch for that one notification. It is always there because keeping
