...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(20347)
val ciVersionName = providers.gradleProperty("versionName").orElse("2.3.0-rc19")
