...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(20341)
val ciVersionName = providers.gradleProperty("versionName").orElse("2.3.0-rc13")
