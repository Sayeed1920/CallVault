...
val ciVersionCode = providers.gradleProperty("versionCode").map { it.toIntOrNull() }.orElse(20332)
val ciVersionName = providers.gradleProperty("versionName").orElse("2.3.0-rc4")
